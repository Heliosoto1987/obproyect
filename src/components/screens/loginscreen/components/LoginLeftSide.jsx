...
export const LoginLeftSide = () => {
    return (
        <div className='loginleftcomponent'>
          <h2 className='loginleftcomponent__title'>OpenBootcamp <span className="loginleftcomponent__title--span"> | Alumnos</span></h2>
            <form className='loginleftcomponent__form'>
                <div className='loginleftcomponentform__box'>
                    ...
                    <input className='loginleftcomponentform__box--input' type="text" placeholder=' Introduce tu correo' id="email"/>
                </div>
                <div className='loginleftcomponentform__box'>
                    <label className="loginleftcomponentform__box--label">Constraseña</label>
                    <input className='loginleftcomponentform__box--input' type="text" placeholder=' Introduce tu contraseña' id="password" />
                </div>
                <div>
